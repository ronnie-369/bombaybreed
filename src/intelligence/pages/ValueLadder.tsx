      ...
      <section className="max-w-[1200px] mx-auto px-6 md:px-10 pt-10 md:pt-14 pb-14">
        ...
        <div className="mt-6 space-y-4 text-[16px] leading-[1.7] text-bb-gray max-w-2xl">
          ...
          <p>
            ...
            your investments, the <a href="#tier-bb-analyst" onClick={(e) => smoothScrollToTier(e, "bb-analyst")} className="text-bb-near-black font-medium underline decoration-bb-border underline-offset-4 hover:decoration-bb-near-black">Investor Intel</a> tier is just for you.
          </p>
          <p>
            ...
            <Folder
              ...
              items={SPONSOR_OPEN_PROJECTS.map((proj, i) => (
                <button
                  ...
                  className="block w-full h-full px-1.5 py-2 text-left bg-transparent focus:outline-none focus-visible:ring-2 focus-visible:ring-bb-slate/40"
                  aria-label={`Register interest in: ${proj.title}`}
                >
                  <div className="text-bb-gold font-serif text-[7px] leading-[1.1]">
                    {String(i + 1).padStart(2, "0")}
                  </div>
                  <div className="mt-1.5 font-serif text-[6px] leading-[1.3] text-bb-near-black line-clamp-4 break-words hyphens-auto">
                    {proj.title}
                  </div>
                  <div className="mt-1.5 text-[4.5px] leading-[1.25] uppercase tracking-[0.1em] text-bb-gray font-mono break-words">
      ...
      >
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
          {[
            ...
            { quote: 'Very methodical and deep analysis.', name: 'Rohit Jhunjhunwala', title: 'Founder', org: 'In44 Capital', orgHref: 'https://in44capital.com/' },
